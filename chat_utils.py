...
def render_chat(df, tab_key):
    ...
    # 3-way cross tabs for compound questions like "CLIMB CREDIT in March - how many attended orientation?"
    ...
    ctx["payment_mode_x_month_x_orientation"]  = cross3("Payment Mode","Refund Month","Orientation Attended")
    ctx["payment_mode_x_month_x_first_class"]  = cross3("Payment Mode","Refund Month","First Class Attended")
    ctx["course_x_month_x_orientation"]        = cross3("Course","Refund Month","Orientation Attended")
    ctx["bu_x_month_x_orientation"]            = cross3("BU","Refund Month","Orientation Attended")
    ctx["reason_x_bu_x_month"]                 = cross3("Refund Category","BU","Refund Month")
    ...
    system_prompt = (
        ...
        "4. For compound questions like 'CLIMB CREDIT in March' use cross-tab keys like payment_mode_by_month For 3-level questions (e.g. CLIMB CREDIT in March who attended orientation) use 3-way keys like payment_mode_x_month_x_orientation.. "
