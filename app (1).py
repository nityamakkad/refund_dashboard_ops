...
with st.sidebar:
    ...
    sel_retained   = multiselect_filter("📋 Sale Retained / Dropped",
                                        clean_series(df_raw["Sale Retained / Dropped"]), "retained")
...
df = apply_str_filter(df, "Sale Retained / Dropped",   sel_retained)
