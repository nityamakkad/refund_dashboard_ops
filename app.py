...
with tab_engagement:
    ...
    st.markdown('<div class="section-header">⑩ Engagement — Orientation & First Class Analysis</div>',
                unsafe_allow_html=True)
    ...
    if total_valid > 0:
        ...
        st.markdown(
            ...
            f'<b>Quick Read:</b> Of {total_valid} learners with attendance data — '
    ...
    with col_e4:
        st.plotly_chart(chart_days_distribution_by_subset(df), use_container_width=True)
